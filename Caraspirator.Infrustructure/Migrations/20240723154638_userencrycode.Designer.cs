...
namespace Caraspirator.Infrustructure.Migrations
{
    ...
    [Migration("20240723154638_userencrycode")]
    partial class userencrycode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Caraspirator.Data.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 23, 16, 46, 38, 46, DateTimeKind.Local).AddTicks(724),
                            IsActive = true,
                            ParentID = 0,
                            Slug = "T-Shirt",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 23, 16, 46, 38, 46, DateTimeKind.Local).AddTicks(777),
                            IsActive = true,
                            ParentID = 0,
                            Slug = "Dresses",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            ...
                            CategoryName = "Tools",
                            CreatedAt = new DateTime(2024, 7, 23, 16, 46, 38, 46, DateTimeKind.Local).AddTicks(780),
                            IsActive = true,
                            ParentID = 0,
                            Slug = "Blouses",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 23, 16, 46, 38, 46, DateTimeKind.Local).AddTicks(782),
                            IsActive = true,
                            ParentID = 0,
                            Slug = "Bottoms",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 23, 16, 46, 38, 46, DateTimeKind.Local).AddTicks(785),
                            IsActive = true,
                            ParentID = 0,
                            Slug = "Beauty",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
