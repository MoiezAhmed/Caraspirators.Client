...
namespace Caraspirator.Services.Implementation
{
    internal class AuthorizationService : IAuthorizationService
    {
        ...
        public AuthorizationService(RoleManager<Role> roleManager, UserManager<EspkUser> userManager, AppDbContext dbContext)
        {
        ...
        public async Task<string> EditRoleAsync(EditRoleRequest request)
        {
            ...
            if (result.Succeeded) return "Success";
            //return list of all error and converted to string with sperated value by -
        ...
        {
            //var Isexist = await _roleManager.FindByNameAsync(roleName);
        ...
        public async Task<ManageUserRolesResult> ManageUserRolesData(EspkUser user)
        {
        ...
        public async Task<ManageUserClaimsResult> ManageUserClaimData(EspkUser user)
        {
